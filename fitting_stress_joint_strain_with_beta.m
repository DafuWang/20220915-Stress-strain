function [A_joint,beta_joint,ultimate_stress,ultimate_strain,R2_joint,save_adress_name,figure_name]=fitting_stress_joint_strain_with_beta(fileadress,filename,NUM_joint,I)
...
[x,y_fitting,beta_joint(i),R2_joint(i),I,I11(i),fig] = strain_stress_fitting_beta(filename,r_stress,strian,I,data_legnend_joint,fiting_legend_joint,initial_a_joint,ultimate_strain(i),i);
A_joint{i,1}=[x,r_stress,y_fitting];initial_a_joint=[beta_joint(i)];
end
figure_name{1,1}=' stress strain fitting with beta';
