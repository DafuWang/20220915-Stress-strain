function [x,y,beta,R2,I,II,fig] = strain_stress_fitting_beta(filename,r_stress,strian,I,dat_legnend,fitting_legnend,a_fitting,constants,i)
%% 取数据
...
[x,y,strain_c,beta,R2]=curve_fiting_beta_parameter(a_fitting,constants,strian,r_stress);
b=1;
