function [A_joint,beta_joint,alpha_joint,ultimate_stress,ultimate_strain,R2_joint_beta,R2_joint_alpha,save_adress_name,figure_name]=fitting_stress_average_strain_with_alpha_beta(fileadress,filename,NUM_joint,I)

Max_strain_fitting=30000;%%%%%%%%%%%%%%%%需修改%%%%%%%%%%%%%%%%%%%%%%%%%%%%
n_intervals=1;%%%%%%%%%%%%%%%%需修改%%%%%%%%%%%%%%%%%%%%%%%%%%%%


data_legnend_joint=["$test\,\overline{G1L1+G2L2}$","$test\,\overline{G1L2+G2L1}$","$test\,\overline{G1L2+G2L2}$","$test\,\overline{G1L1+G2L1}$"];
fiting1_legend_joint=["$fit\,\overline{G1L1+G2L2}\,with\,\beta$","$fit\,\overline{G1L2+G2L1}\\,with\,\beta$","$fit\,\overline{G1L2+G2L2}\,with\,\beta$","$fit\,\overline{G1L1+G2L1}\,with\,\beta$"];
fiting2_legend_joint=["$fit\,\overline{G1L1+G2L2}\,with\,\alpha$","$fit\,\overline{G1L2+G2L1}\,with\,\alpha$","$fit\,\overline{G1L2+G2L2}\,with\,\alpha$","$fit\,\overline{G1L1+G2L1}\,with\,\alpha$"];
...
% critical_value=[21000,23000,23000,25000];
...
fileadress0=strcat(fileadress,'\',filename,'stress avrage-strain with alpha beta',num2str(i),'.fig');
...
figure_name{1,1}=' stress-average strain fitting with alpha beta';
