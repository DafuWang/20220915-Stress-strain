function [I2]=fitted_and_original_data_save_nb(A_joint,beta_joint,b_joint,R2_joint,A_average,beta_average,b_average,R2_average,A_joint_beta,beta_joint_beta,R2_joint_beta,A_average_beta,beta_average_beta,R2_average_beta,A_joint_code,beta_joint_code,alpha_joint,R2_joint_beta_code,R2_joint_alph,A_average_code,beta_average_code,alpha_average,R2_average_beta_code,R2_average_alph,fileadress,filename)
 % 原始数据储存，便以用origin画图
...
I2=1;%用于计量表中的列
xlswrite(excel_adress_name,{'拟合方法'},sheet_number5,strcat(char(65+I2-1),'1'));%写入样本
xlswrite(excel_adress_name,{'规范分段拟合法'},sheet_number5,strcat(char(65+I2-1),'2'));%样本名
xlswrite(excel_adress_name,{'样品名'},sheet_number5,strcat(char(65+I2-1),'3'));%写入样本
xlswrite(excel_adress_name,{filename},sheet_number5,strcat(char(65+I2-1),'4'));%样本名
I2=I2+1;
...
I2=1;%用于计量表中的列
xlswrite(excel_adress_name,{'拟合方法'},sheet_number6,strcat(char(65+I2-1),'1'));%写入样本
xlswrite(excel_adress_name,{'规范分段拟合法'},sheet_number6,strcat(char(65+I2-1),'2'));%样本名
xlswrite(excel_adress_name,{'样品名'},sheet_number6,strcat(char(65+I2-1),'3'));%写入样本
xlswrite(excel_adress_name,{filename},sheet_number6,strcat(char(65+I2-1),'4'));%样本名
I2=I2+1;
