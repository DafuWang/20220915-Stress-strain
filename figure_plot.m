function [II,I]=figure_plot(M,N_intervals,legend_content,legend_position,text_content,text_position,marks,colors,Asix,label_content,save_adress_name,I)
...
set(gca,'defaultfigurecolor','w');%设定背景颜色为白色
%% 文本输出
